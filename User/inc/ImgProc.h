...
#define SHIFT                       3
#define MASK                        0x07
#define SetImgBufAsBitMap(row, col) (imgBuf[row][(col) >> SHIFT] |=  (1 << ((col) & MASK)))
#define ClrImgBufAsBitMap(row, col) (imgBuf[row][(col) >> SHIFT] &= ~(1 << ((col) & MASK)))
#define TstImgBufAsBitMap(row, col) (imgBuf[row][(col) >> SHIFT] &   (1 << ((col) & MASK)))
...
extern uint8_t imgBuf[OV7725_H][OV7725_W / 2];
